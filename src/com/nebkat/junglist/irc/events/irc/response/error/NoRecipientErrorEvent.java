...
public class NoRecipientErrorEvent extends ErrorMessageEvent {
    public NoRecipientErrorEvent(long time, Session session, String data, Source source, String message) {
