...
public class NoTextToSendErrorEvent extends ErrorMessageEvent {
    public NoTextToSendErrorEvent(long time, Session session, String data, Source source, String message) {
