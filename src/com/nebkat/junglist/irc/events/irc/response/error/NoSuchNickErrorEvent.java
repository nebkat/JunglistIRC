...
public class NoSuchNickErrorEvent extends ErrorMessageEvent {
    protected final String mNick;

    public NoSuchNickErrorEvent(long time, Session session, String data, Source source, String message, String nick) {
