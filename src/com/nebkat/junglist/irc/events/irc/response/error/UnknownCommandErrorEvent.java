...
public class UnknownCommandErrorEvent extends ErrorMessageEvent {
    protected final String mCommand;

    public UnknownCommandErrorEvent(long time, Session session, String data, Source source, String message, String command) {
