...
public class ResponseChannelUrlEvent extends ResponseChannelEvent {
    protected final String mUrl;

    public ResponseChannelUrlEvent(long time, Session session, String data, Source source, Channel channel, String url) {
