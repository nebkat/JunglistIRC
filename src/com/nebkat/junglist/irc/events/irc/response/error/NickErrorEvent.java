...
public abstract class NickErrorEvent extends ErrorMessageEvent {
    public NickErrorEvent(long time, Session session, String data, Source source, String message) {
