...
public class NickInUseErrorEvent extends NickErrorEvent {
    protected final String mNick;

    public NickInUseErrorEvent(long time, Session session, String data, Source source, String message, String nick) {
