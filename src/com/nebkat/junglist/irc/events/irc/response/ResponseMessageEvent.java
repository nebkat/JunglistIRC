...
public abstract class ResponseMessageEvent extends ResponseEvent {
    protected final String mMessage;

    public ResponseMessageEvent(long time, Session session, String data, Source source, String message) {
