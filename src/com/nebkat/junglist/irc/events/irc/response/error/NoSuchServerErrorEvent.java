...
public class NoSuchServerErrorEvent extends ErrorMessageEvent {
    protected final String mServer;

    public NoSuchServerErrorEvent(long time, Session session, String data, Source source, String message, String server) {
