...
public abstract class ResponseTopicEvent extends ResponseChannelEvent {
    public ResponseTopicEvent(long time, Session session, String data, Source source, Channel channel) {
