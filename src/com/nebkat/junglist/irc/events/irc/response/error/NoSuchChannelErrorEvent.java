...
public class NoSuchChannelErrorEvent extends ErrorMessageEvent {
    protected final String mChannel;

    public NoSuchChannelErrorEvent(long time, Session session, String data, Source source, String message, String channel) {
