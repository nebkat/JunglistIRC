...
public class ServerConnectedEvent extends ResponseEvent {
    private final String mWelcomeMessage;

    public ServerConnectedEvent(long time, Session session, String data, Source source, String welcomeMessage) {
