...
public class CannotSendToChanErrorEvent extends ErrorMessageEvent {
    protected final String mChannel;

    public CannotSendToChanErrorEvent(long time, Session session, String data, Source source, String message, String channel) {
