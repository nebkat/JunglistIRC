...
import com.nebkat.junglist.irc.events.irc.ChannelEvent;

public abstract class ResponseChannelEvent extends ResponseEvent implements ChannelEvent {
    protected final Channel mChannel;

    public ResponseChannelEvent(long time, Session session, String data, Source source, Channel channel) {
