...
public class NoNickGivenErrorEvent extends NickErrorEvent {
    public NoNickGivenErrorEvent(long time, Session session, String data, Source source, String message) {
