...
public class WrongPasswordErrorEvent extends ErrorMessageEvent {
    public WrongPasswordErrorEvent(long time, Session session, String data, Source source, String message) {
