...
public class NickInvalidErrorEvent extends NickErrorEvent {
    protected final String mNick;

    public NickInvalidErrorEvent(long time, Session session, String data, Source source, String message, String nick) {
