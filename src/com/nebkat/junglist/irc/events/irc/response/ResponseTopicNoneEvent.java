...
public class ResponseTopicNoneEvent extends ResponseTopicEvent {
    public ResponseTopicNoneEvent(long time, Session session, String data, Source source, Channel channel) {
