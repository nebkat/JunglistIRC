...
public class TooManyChansErrorEvent extends ErrorMessageEvent {
    protected final String mChannel;

    public TooManyChansErrorEvent(long time, Session session, String data, Source source, String message, String channel) {
