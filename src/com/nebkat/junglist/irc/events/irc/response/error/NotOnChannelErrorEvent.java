...
public class NotOnChannelErrorEvent extends ErrorMessageEvent {
    protected final String mChannel;

    public NotOnChannelErrorEvent(long time, Session session, String data, Source source, String message, String channel) {
