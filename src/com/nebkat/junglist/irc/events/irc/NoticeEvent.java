...
/**
 * Notice channel/private message event
 */
public class NoticeEvent extends MessageEvent {
     ...
     * @see MessageEvent
     */
    public NoticeEvent(long time, Session session, String data, Source source, Target target, String message) {
        super(time, session, data, source, target, message);
    }

    @Override
    public String toString() {
        return "[" + getClass().getSimpleName() + "] <" + mSource.getNick() + "> sent a notice \"" + mMessage + "\" to " + mTarget.getName();
    }
}
