...
public class SystemOutLogger implements Log.Logger {
    @Override
    public void log(Log.Level level, String tag, String message) {
        System.out.println(level.name().substring(0, 1) + "/" + tag + ": " + message);
    }
    ...
    public void log(Log.Level level, String tag, Throwable throwable) {
        ...
        for (String s : stackTrace) {
            System.out.println(level.name().substring(0, 1) + "/" + tag + ": " + s);
        }
    }
}
